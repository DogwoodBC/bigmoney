...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'bigmoney/templates/')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'bigmoney.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': (
        ...
        # 'rest_framework_csv.renderers.CSVRenderer',  # Turned off until I can properly integrate with pagination.
    ),
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'hughstimson@gmail.com'
EMAIL_HOST_PASSWORD = '****'
